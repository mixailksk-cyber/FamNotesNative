...
import { formatDate, getBrandColor } from '../utils/constants';
  ...
  return (
    ...
    >
      <View style={{
        ...
        height: 52,
        borderRadius: 26,
        backgroundColor: item.color || brandColor,
        marginRight: 16,
      ...
      {showPin && item.pinned && <Icon name="push-pin" size={20} color={brandColor} style={{ marginLeft: 8 }} />}
    </TouchableOpacity>
  );
};
